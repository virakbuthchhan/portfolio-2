...
interface ShaderPassProps {
    ...
    output?: THREE.WebGLRenderTarget | null | undefined;
    output0?: THREE.WebGLRenderTarget | null | undefined;
    output1?: THREE.WebGLRenderTarget | null | undefined;
}
...
export default function LiquidEther({
  ...
  `;
        ...
        class Advection extends ShaderPass {
            ...
            update(...args: unknown[]) {
                const {dt: dt_, isBounce, BFECC} = (args[0] || {}) as UpdateArgs;
                if (!this.uniforms) return;
                if (typeof dt_ === 'number') this.uniforms.dt.value = dt_;
        ...
        class ExternalForce extends ShaderPass {
            ...
            update(...args: unknown[]) {
                const props = (args[0] || {}) as UpdateArgs;
        ...
        class Viscous extends ShaderPass {
            ...
            update(...args: unknown[]) {
                const {viscous: visc, iterations, dt: dt_} = (args[0] || {}) as UpdateArgs;
                if (!this.uniforms) return;
        ...
        class Divergence extends ShaderPass {
            ...
            update(...args: unknown[]) {
                const {vel} = (args[0] || {}) as UpdateArgs;
        ...
        class Pressure extends ShaderPass {
            ...
            update(...args: unknown[]) {
                const {vel, pressure: pres} = (args[0] || {}) as UpdateArgs;
                if (this.uniforms && vel && pres) {
                    this.uniforms.velocity.value = vel.texture;
                    this.uniforms.pressure.value = pres.texture;
                }
                super.update();
            }
        }
        ...
        class Simulation {
            ...
            update() {
                ...
                const pressure = this.poisson.update({iterations_poisson: this.options.iterations_poisson});
